  ...
  )
{
  ...
  /* Enable SD card power via GPIO4_PB4 */
  ...
  )
{
  ...
  /* Set GPIO0 PB0 (USB_HOST20) output high to power USB 2.0 ports */
  GpioPinWrite (0, GPIO_PIN_PB0, TRUE);
  ...
  )
{
  switch (Id) {
    case 0:
      /* Enable HDMI via GPIO4_PB6 */
      GpioPinWrite (4, GPIO_PIN_PB6, TRUE);
